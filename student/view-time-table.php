                        ...
                        <div class="row">
                  	 		<div id="content" class="col-md-12">
                  	 			<center><h2>CLASS TIMETABLE FOR <?php if(isset($_POST['session']) && isset($_POST['session'])){
                  	 				...
                  	 				<center><h2>Department of <?php if(isset($_SESSION['student_dept']) && isset($_POST['level'])){
                  	 				echo $dept->get_dept($_SESSION['student_dept'])->dept_title .' '.$dept->get_level($_POST['level'])->level.'Level';}?> </h2></center>
                  	 			<table class="table table-bordered content"></center>
									...
									<?php
										...
										// }
										if(isset($_SESSION['student_dept'],$_POST['session'],$_POST['semester'],$_POST['level'])){
									?>
									<tr>
										<td>M</td>
