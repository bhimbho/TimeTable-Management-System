                        ...
                        <div class="row">
                  	 		<div id="content" class="col-md-12">
                  	 			<center><h2>CLASS TIMETABLE FOR <?php if(isset($_POST['session']) && isset($_POST['session'])){
                  	 				...
                  	 				<center><h2>Department of <?php if(isset($_POST['dept']) && isset($_POST['level'])){
                  	 				echo $dept->get_dept($_POST['dept'])->dept_title .' '.$dept->get_level($_POST['level'])->level.'Level';}?> </h2></center>
